...
def encode_bytes(plaintext, iNumBits):
...
def encrypt_file(key, input_file):
    with open(input_file, 'rb') as f:
        plaintext = f.read()
    z = encode_bytes(plaintext, key.iNumBits)
    ...
    for i in z:
        ...
        cipher_pairs.append([c, d])
    return cipher_pairs
def decode_bytes(aiPlaintext, iNumBits):
    bytes_array = []
...
def decrypt_file(key, input_file):
    ...
    decoded_text = decode_bytes(plaintext, key.iNumBits)
...
def test():
    ...
    encrypt_file(pub, input_file, encrypted_file)

    decrypt_file(priv, encrypted_file, decrypted_file)
